...
enum L {
    static let strings: [String: [UILang: String]] = [
        ...
        "onboarding.welcome.preparing": [.zh: "正在准备语音模型...",
                                         .en: "Preparing speech model...",
                                         .de: "Spracherkennung wird vorbereitet..."],
        "onboarding.welcome.preparingHint": [.zh: "首次启动需 1-3 分钟下载 ~500MB",
                                             .en: "First launch downloads ~500MB (1-3 min)",
                                             .de: "Erstes Laden lädt ~500 MB (1-3 Min)"],
