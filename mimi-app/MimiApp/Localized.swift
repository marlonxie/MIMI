...
enum L {
    static let strings: [String: [UILang: String]] = [
        ...
        "upload.alert.indexing":    [.zh: "已复制 %d 个文件，正在重建索引...",
                                     .en: "Copied %d file(s); rebuilding index...",
                                     .de: "%d Datei(en) kopiert; Index wird neu erstellt..."],
        "upload.alert.indexed":     [.zh: "已索引 %d 个文件，回答提示已可用",
                                     .en: "Indexed %d file(s); suggestions ready",
                                     .de: "%d Datei(en) indiziert; Vorschläge bereit"],
        "upload.alert.indexFailed": [.zh: "索引失败：%@",
                                     .en: "Indexing failed: %@",
                                     .de: "Indizierung fehlgeschlagen: %@"],
