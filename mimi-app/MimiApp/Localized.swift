...
enum L {
    static let strings: [String: [UILang: String]] = [
        ...
        "settings.nativeLanguage.cloudHint": [
            .zh: "本地 Qwen3 翻译这些母语质量一般，建议在 API tab 切到 Gemini / Claude / OpenAI。",
            .en: "Local Qwen3 translation for this native language is limited; switching to Gemini / Claude / OpenAI in the API tab is recommended.",
            .de: "Lokale Qwen3-Übersetzung für diese Muttersprache ist begrenzt; wir empfehlen Gemini / Claude / OpenAI im API-Tab.",
        ],
        ...
        "onboarding.settings.lang": [.zh: "语言：选面试用语言和母语",
                                     .en: "Language: pick your interview language and native language",
                                     .de: "Sprache: Interview- und Muttersprache wählen"],
