...
class RAGIndexer:
    ...
    def __init__(self, config_path: str = None):
        ...
        self.resources_path = Path(__file__).parent.parent / rag_config["resources_path"]
        self.chroma_path = str(Path(__file__).parent.parent / rag_config["chroma_path"])
